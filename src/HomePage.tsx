    ...
    <div className="home-page">
      <section className="home-hero">
        ...
        <h1 className="home-title">
          Know your customers before you say yes.
        </h1>
      ...
      <section className="home-legal">
        ...
        <p>
          ...
          voluntarily by users for the sole purpose of helping businesses,
          sales representatives, contractors, suppliers, and other
          professionals evaluate customers based on real payment and
        ...
        <p>
          ...
          Rycus and its owners are not responsible for the accuracy,
          content, opinions, or statements provided by users, as all
          reviews reflect the personal experience and viewpoint of the
          member who submitted them.
        </p>

        <p>
          By using this platform, you agree to use all information
